...
* `Creat` - should create a new for a current user. A shape of data send by a client application to this function can be found in the `CreatProductRequest.ts` file
